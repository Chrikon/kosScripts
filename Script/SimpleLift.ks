...
//Simple lift without booster's

parameter altitude_d is 90000,thrust_d is 1,direction_d is 90.
...
until ship:apoapsis>ship_apoapsis{
    ...
    if(flag and ship:verticalspeed>100){
...
function main{
    if(ship:sensors:pres>0.1 and altitude_d>ship:orbit:body:atm:height){
        ascent(altitude_d,thrust_d,direction_d).
        //Αρχική manuver
