...
parameter booster_d is true,altitude_d is 100000,thrust_d is 1,direction_d is 90.
...
declare local booster is booster_d.
...
until ship:apoapsis>ship_apoapsis{
    ...
    }else if ship:maxThrust<thrust and booster{
